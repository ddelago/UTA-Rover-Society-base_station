...
if("TRUE" STREQUAL "TRUE")
  set(rosToArduino_SOURCE_PREFIX /home/rover/rover_embedded/catkin_ws/src/rosToArduino)
  set(rosToArduino_DEVEL_PREFIX /home/rover/rover_embedded/catkin_ws/devel)
  ...
  set(rosToArduino_INSTALL_PREFIX /home/rover/rover_embedded/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosToArduino' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rover/rover_embedded/catkin_ws/src/rosToArduino/${idir}'.  Ask the maintainer 'Daniel Delago <ddelago0596@gmail.com>' to fix it.")
    endif()
...
set(rosToArduino_EXPORTED_TARGETS "")
