...
if("TRUE" STREQUAL "TRUE")
  set(logger_binding_SOURCE_PREFIX /home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/logger_binding)
  set(logger_binding_DEVEL_PREFIX /home/rover/rover_embedded/catkin_ws/devel)
  ...
  set(logger_binding_INSTALL_PREFIX /home/rover/rover_embedded/catkin_ws/install)
...
if(NOT "/home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/logger_binding/include;/home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/baselib_binding/include " STREQUAL " ")
  set(logger_binding_INCLUDE_DIRS "")
  set(_include_dirs "/home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/logger_binding/include;/home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/baselib_binding/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'logger_binding' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jennifer Buehler <jennifer.e.buehler@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'logger_binding' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/logger_binding/${idir}'.  Ask the maintainer 'Jennifer Buehler <jennifer.e.buehler@gmail.com>' to fix it.")
    endif()
    _list_append_unique(logger_binding_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "logger_binding_boost")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rover/rover_embedded/catkin_ws/devel/lib;/home/rover/rover_base/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${logger_binding_dep}_FOUND)
      find_package(${logger_binding_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${logger_binding_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "/home/rover/rover_embedded/catkin_ws/src/convenience-pkgs/logger_binding/cmake/logger_bindingConfigExtras.cmake")
