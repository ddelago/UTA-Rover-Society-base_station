...
if("TRUE" STREQUAL "TRUE")
  set(display_SOURCE_PREFIX /home/ivan/roverROS/src/display)
  set(display_DEVEL_PREFIX /home/ivan/roverROS/build-src-Desktop-Default/devel)
  set(display_INSTALL_PREFIX "")
  set(display_PREFIX ${display_DEVEL_PREFIX})
else()
  set(display_SOURCE_PREFIX "")
  set(display_DEVEL_PREFIX "")
  set(display_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'display' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ivan/roverROS/src/display/${idir}'.  Ask the maintainer 'ivan <ivan@todo.todo>' to fix it.")
    endif()
