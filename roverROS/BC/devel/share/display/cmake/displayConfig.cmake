...
if("TRUE" STREQUAL "TRUE")
  set(display_SOURCE_PREFIX /home/rover/Desktop/rover_base/roverROS/BC/src/display)
  set(display_DEVEL_PREFIX /home/rover/Desktop/rover_base/roverROS/BC/devel)
  set(display_INSTALL_PREFIX "")
  set(display_PREFIX ${display_DEVEL_PREFIX})
else()
  set(display_SOURCE_PREFIX "")
  set(display_DEVEL_PREFIX "")
  set(display_INSTALL_PREFIX /home/rover/Desktop/rover_base/roverROS/BC/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'display' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ivan <ivan@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'display' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rover/Desktop/rover_base/roverROS/BC/src/display/${idir}'.  Ask the maintainer 'ivan <ivan@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${display_dep}_FOUND)
      find_package(${display_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${display_dep} REQUIRED ${depend_list})
  endif()
