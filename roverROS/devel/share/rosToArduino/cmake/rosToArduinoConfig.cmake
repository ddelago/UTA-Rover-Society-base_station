...
if("TRUE" STREQUAL "TRUE")
  set(rosToArduino_SOURCE_PREFIX /home/daniel/rover_base/roverROS/src/rosToArduino)
  set(rosToArduino_DEVEL_PREFIX /home/daniel/rover_base/roverROS/devel)
  ...
  set(rosToArduino_INSTALL_PREFIX /home/daniel/rover_base/roverROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosToArduino' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/daniel/rover_base/roverROS/src/rosToArduino/${idir}'.  Ask the maintainer 'Daniel Delago <ddelago0596@gmail.com>' to fix it.")
    endif()
